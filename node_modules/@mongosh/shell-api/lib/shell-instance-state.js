    ...
    getAutocompletionContext() {
        return {
            ...
            schemaInformationForCollection: async (connectionId, databaseName, collectionName) => {
                ...
                const mongo = this.getMongoByConnectionId(connectionId);
                let docs = [];
                if ((await ((_b = (_a = this.evaluationListener).getConfig) === null || _b === void 0 ? void 0 : _b.call(_a, 'disableSchemaSampling'))) !== true) {
                    try {
                        docs = await mongo
                            ._getDb(databaseName)
