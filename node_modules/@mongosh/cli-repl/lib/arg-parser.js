...
function verifyCliArguments(args) {
    ...
    if (![undefined, true, false, 'redacted', 'include-secrets'].includes(args.oidcDumpTokens)) {
        throw new errors_1.MongoshUnimplementedError('--oidcDumpTokens can only have the values redacted or include-secrets', errors_1.CommonErrors.InvalidArgument);
    }
    const messages = [];
