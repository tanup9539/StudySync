...
async function ensureMatchingPermissions(filename, execPathStat) {
    ...
    if ((stat.uid !== execPathStat.uid && stat.uid !== ((_a = process.getuid) === null || _a === void 0 ? void 0 : _a.call(process))) ||
        (stat.gid !== execPathStat.gid && stat.gid !== ((_b = process.getgid) === null || _b === void 0 ? void 0 : _b.call(process))) ||
        stat.mode & 0o002) {
        return {
            libraryStat: { uid: stat.uid, gid: stat.gid, mode: stat.mode },
            mongoshStat: { uid: execPathStat.uid, gid: stat.gid },
            currentUser: { uid: (_c = process.getuid) === null || _c === void 0 ? void 0 : _c.call(process), gid: (_d = process.getgid) === null || _d === void 0 ? void 0 : _d.call(process) },
        };
    }
    return null;
}
